      ...
      <div class="form-grid">
        ...
        <div class="form-group full" style="margin-top:16px;padding-top:16px;border-top:1px solid #334155">
          ...
          <div style="display:flex;flex-direction:column;gap:16px">
            ...
            @php
              $hasSelectedSub = $parent->children->filter(fn($sub) => $store->categories->contains($sub->id))->isNotEmpty();
            @endphp
            <div>
              ...
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;padding-bottom:6px;border-bottom:1px solid #334155">
                ...
                <button type="button" onclick="toggleSubcats('subcats-{{ $parent->id }}')"
                  ...
                  <span id="subcats-{{ $parent->id }}-icon" style="transition:transform .2s;font-size:8px;{{ $hasSelectedSub ? 'transform:rotate(90deg)' : '' }}">▶</span>
              ...
              {{-- Subcategories (hidden by default, shown if any selected) --}}
              @if($parent->children->count() > 0)
              <div id="subcats-{{ $parent->id }}" style="display:{{ $hasSelectedSub ? 'flex' : 'none' }};flex-wrap:wrap;gap:6px;padding-left:8px;margin-top:8px">
