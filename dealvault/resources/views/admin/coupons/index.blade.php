...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;flex-wrap:wrap;gap:12px">
  <div style="display:flex;align-items:center;gap:12px">
    <form method="GET" action="{{ route('admin.coupons.index') }}" style="display:flex;gap:8px">
      ...
      @if($search)
      <a href="{{ route('admin.coupons.index') }}" class="btn btn-gray btn-sm">Clear</a>
      @endif
    </form>
    <span style="font-size:13px;color:#64748b">{{ $coupons->total() }} coupons</span>
  </div>
